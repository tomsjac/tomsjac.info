...
function portfolio() {
	...
	var initSliderProjet = function() {
		//Ini
		var slideProjet = new sliderPage(
			{
				'idSlider' 		: 'listProj',
				'balisePane'    : 'li',
				'idSlideDepart'	: 'block0-pane',
				'idMenuSlider'  : 'menuSlide',
				'cssMenuActif'  : 'active'
			}
		);
		
		document.getElementById('navListPLeft').onclick = function(){
			slideProjet.scrollDirection('prev'); // allez au slide précédent
		}
		
		document.getElementById('navListPRight').onclick = function(){
			slideProjet.scrollDirection('next'); // allez au slide suivant
		}
	};
...
function portfolioProjet() {
	...
	var initSliderImg = function() {
		//Ini
		var slideImg = new sliderPage(
			{
				'idSlider' 		: 'slideImgDProj',
				'balisePane'    : 'li',
				'idSlideDepart'	: 'img0-pane',
				'idMenuSlider'  : 'menuImgSlide',
				'cssMenuActif'  : 'active'
			}
		);
		
		document.getElementById('navImgSlideLeft').onclick = function(){
			slideImg.scrollDirection('prev'); // allez au slide précédent
		}
		
		document.getElementById('navImgSlideRight').onclick = function(){
			slideImg.scrollDirection('next'); // allez au slide suivant
		}
	};
	...
	var initZoomImg = function() {
		...
		var listObjImgZoom = document.getElementById('slideImgDProj').querySelectorAll(
		...
		var listObjImgSlideA = document.getElementById('slideImgDProj').querySelectorAll("#slideImgDProj > ul > li > a");
	...
	var initNavZoom = function(zoomSelect) {
		...
		var elementSlide = document.getElementById('slideImgDProj');
